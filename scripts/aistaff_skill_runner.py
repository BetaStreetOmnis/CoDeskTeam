...
from backend.aistaff_api.config import load_settings  # noqa: E402
from backend.aistaff_api.services.doc_service import DocService  # noqa: E402
from backend.aistaff_api.services.prototype_service import PrototypeService  # noqa: E402
...
def main() -> None:
    parser = argparse.ArgumentParser(description="aistaff skill runner")
    parser.add_argument(
        "action",
        choices=[
            "ppt",
